...
const image_entity_1 = require("./modules/image/image.entity");
const video_entity_1 = require("./modules/video/video.entity");
        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (configService) => {
                    ...
                    return {
                        ...postgresConfig,
                        entities: [category_entity_1.Category, image_entity_1.Image, transaction_entity_1.TransactionEntity, video_entity_1.Video],
                    };
                },
